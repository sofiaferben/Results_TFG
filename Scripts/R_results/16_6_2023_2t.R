...
excel_file <- "16_6_2023_2t_R.xlsx"
...
my_colors <- brewer.pal(num_colors, "Set3")
...
ggsave("16_6_2023_toggle_switch_GFP_IPTG_normalization_2_transfer_plot.png", plot = GFP_IPTG_normalization,  width = 5,height = 4.50,units = "in",dpi = 500)
